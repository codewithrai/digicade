...
export type PartialUpdatePlayer = Partial<IUser> & Pick<IUser, 'id'>;
...
export class UserService {
  ...
  partialUpdate(user: PartialUpdatePlayer): Observable<EntityResponseType> {
    return this.http.patch<IUser>(`${this.resourceUrl}/${this.getUserIdentifier(user)}`, user, { observe: 'response' });
  }
  ...
  comparePlayer(o1: Pick<IUser, 'id'> | null, o2: Pick<IUser, 'id'> | null): boolean {
    return o1 && o2 ? this.getUserIdentifier(o1) === this.getUserIdentifier(o2) : o1 === o2;
  }

  addPlayerToCollectionIfMissing<Type extends Pick<IUser, 'id'>>(
    userCollection: Type[],
