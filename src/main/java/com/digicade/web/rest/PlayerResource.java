...
/**
 * REST controller for managing {@link com.digicade.domain.Player}.
 */
@RestController
@RequestMapping("/api")
public class PlayerResource {
    ...
    public ResponseEntity<List<PlayerDTO>> getAllPlayers(
        ...
        if ("digiuser-is-null".equals(filter)) {
            log.debug("REST request to get all Players where digiUser is null");
            return new ResponseEntity<>(playerService.findAllWhereDigiUserIsNull(), HttpStatus.OK);
        }
