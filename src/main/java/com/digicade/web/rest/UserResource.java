...
import com.digicade.service.MailService;
...
import com.digicade.web.rest.errors.EmailAlreadyUsedException;
import com.digicade.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link com.digicade.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            User newUser = userService.registerUser(userDTO, userDTO.getLogin());
